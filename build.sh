...
export PATH=/work/pi_huiguan_umass_edu/sandeep/conda_environment/dgl_groot/bin:$PATH
...
cmake -B build -GNinja -DCMAKE_BUILD_TYPE=debug -DBUILD_TYPE=debug -DCMAKE_POLICY_VERSION_MINIMUM=3.5
