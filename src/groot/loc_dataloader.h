    ...
    namespace dgl::groot {
        ...
        public:
            ...
            DataloaderObject(
                    ...
                    NDArray indptr, NDArray indices, NDArray feats,
                    NDArray labels, NDArray train_idx, NDArray valid_idx, NDArray test_idx) {
                Init(rank, world_size, ctx, fanouts, batch_size, max_pool_size,
                     indptr, indices, feats, labels, train_idx, valid_idx, test_idx);
            };
            ...
            void Init(
                    ...
                    std::vector<int64_t> fanouts,
                    int64_t batch_size, int64_t max_pool_size,
                    NDArray indptr, NDArray indices, NDArray feats, NDArray labels,
                    NDArray train_idx, NDArray valid_idx, NDArray test_idx) {
            ...
            NDArray GetNextSeeds(int64_t key) {
                ...
                const int64_t end_idx = std::min(_train_idx.NumElements(), start_idx + _batch_size);
                return _train_idx.CreateView({end_idx - start_idx}, _id_type, start_idx * _id_type.bits / 8);
            }
