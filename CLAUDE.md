...
This is **Spara** (also referred to as **groot** in config/naming), an efficient distributed GNN (Graph Neural Network) training system built on top of DGL (Deep Graph Library). It introduces partition-aware sampling and feature loading to accelerate multi-GPU GNN training.
