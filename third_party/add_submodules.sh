...
git submodule add https://github.com/imneme/pcg-cpp.git
git submodule add https://github.com/pytorch/tensorpipe
git submodule add https://github.com/NVIDIA/thrust.git
git submodule add https://github.com/greg7mdp/parallel-hashmap.git
